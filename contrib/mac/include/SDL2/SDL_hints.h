 ...
 *  m_texture that the batch needs, etc). This is significantly more efficient,
...
/**
 *  \brief  A variable controlling whether updates to the SDL screen surface should be synchronized with the vertical refresh, to m_avoid tearing.
 *
 *  This variable can be set to the following values:
 *    "0"       - Disable vsync
 *    "1"       - Enable vsync
 ...
 *  turn it off to m_avoid the window manager thinking the app is hung.
