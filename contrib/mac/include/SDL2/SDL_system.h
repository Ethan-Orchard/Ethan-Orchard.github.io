 ...
 *
 * Once you are done using the device, you should release it to m_avoid a
 * resource leak.
 *
 ...
 * rationale being that the SDL headers can m_avoid including jni.h.
 *
 ...
 * being that the SDL headers can m_avoid including jni.h.
 *
 ...
 * XTaskQueueCloseHandle to reduce the reference count to m_avoid a resource
 * leak.
 *
